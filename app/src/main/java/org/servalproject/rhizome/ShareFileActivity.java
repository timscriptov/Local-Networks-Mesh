                ...
                try {
                    ...
                    if (displayToast) {
                        ServalBatPhoneApplication.getContext()
                                .displayToastMessage(ServalBatPhoneApplication.getContext()
                                        .getResources()
                                        .getText(
        ...
        if (Intent.ACTION_SEND.equals(action)) {
            ...
            if (uri != null) {
                try {
                    ...
                    ServalBatPhoneApplication.getContext().displayToastMessage(e
                            .toString());
                }
            ...
            ServalBatPhoneApplication.getContext().displayToastMessage("Intent "
