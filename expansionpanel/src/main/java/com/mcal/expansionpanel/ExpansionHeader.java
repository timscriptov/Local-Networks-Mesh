package com.mcal.expansionpanel;
...
public class ExpansionHeader extends FrameLayout {
    ...
    public ExpansionHeader(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public ExpansionHeader(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setExpansionHeaderIndicator(View headerIndicator) {
