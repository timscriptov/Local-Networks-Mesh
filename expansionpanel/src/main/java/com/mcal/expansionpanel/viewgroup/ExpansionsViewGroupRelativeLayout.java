...
public class ExpansionsViewGroupRelativeLayout extends LinearLayout {
    ...
    public ExpansionsViewGroupRelativeLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public ExpansionsViewGroupRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
